    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-10">
                ...
                <div class="col-3">
                    <img class="img-fluid" src="<?php echo '../images/profile'.$product['id'].'.jpg';?>">
                </div>
                <div class="col-6">
                    <h5>
                        <?php echo 'Name: '.$product['product_name'];?>
                    </h5>
                ...
                <div class="col-3">
                    <form method=post action="<?php echo $_SERVER['PHP_SELF'];?>">
                        <a href="<?php echo 'edit.php?id='.$product['id'];?>" class="btn btn-primary">Edit</a>
